...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.stage'
        db.add_column(u'nodes_node', 'stage',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding unique constraint on 'Title', fields ['title']
        db.create_unique(u'nodes_title', ['title'])


    def backwards(self, orm):
        # Removing unique constraint on 'Title', fields ['title']
        db.delete_unique(u'nodes_title', ['title'])

        # Deleting field 'Node.stage'
        db.delete_column(u'nodes_node', 'stage')
